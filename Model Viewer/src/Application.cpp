...
bool Application::Startup()
{
    ...
    // Create Window
    p_window = glfwCreateWindow(m_windowWidth, m_windowHeight,
        "OpenGL Class Project", nullptr, nullptr);
    ...
    // Load shaders
    // shaderSimple.loadShader(aie::eShaderStage::VERTEX,
    // "./Shader/Vertex/simple.vert");
    // shaderSimple.loadShader(aie::eShaderStage::FRAGMENT,"./Shader/Fragment/simple.frag");
    m_shaderPhong.loadShader(
        aie::eShaderStage::VERTEX, "./Shader/Vertex/phong.vert");
    m_shaderPhong.loadShader(
        aie::eShaderStage::FRAGMENT, "./Shader/Fragment/phong.frag");
...
bool Application::Update()
{
    ...
    ImGui::DragFloat3(
        "Sunlight Direction", &m_light.direction[0], 0.1f, -1.0f, 1.0f);
...
void Application::Draw()
{
    ...
    glm::mat4 pv = m_camera.GetProjectionMatrix(m_windowWidth, m_windowHeight)
